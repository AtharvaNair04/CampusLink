...
class _ClassroomFinderPageState extends State<ClassroomFinderPage> {
  ...
  void _bookClassroom(String classroomName) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Confirm Booking'),
        content: Text(
          'Do you want to book $classroomName?\n\n'
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              setState(() {
                allClassrooms[classroomName] = true; // Mark as booked
              });
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('$classroomName booked successfully!'),
  ...
  Widget _buildClassroomCard(String classroomName) {
    return GestureDetector(
      onTap: () => _bookClassroom(classroomName),
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(16),
